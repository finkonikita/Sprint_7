...
class TestCreateCourier:
    ...
    def test_create_courier_twice(self, registered_courier):
    ...
    def test_create_courier_without_first_name(self, helpers):
        ...
        with allure.step("Удаляем созданного курьера"):
            helpers.delete_courier(login, password)#удаление курьера не вынесено в фикстуру, так как курьер создаётся локально только в этом тесте